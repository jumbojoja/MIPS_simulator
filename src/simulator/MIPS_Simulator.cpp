...
MIPS_Simulator::MIPS_Simulator()
    : registers(REGISTER_SIZE, 0), memory(MEMORY_SIZE, 0), pc(0) {
...
void MIPS_Simulator::executed() { pc += 4; }
...
int MIPS_Simulator::getRegister(int reg) const { return registers[reg]; }

void MIPS_Simulator::setRegister(int reg, int value) { registers[reg] = value; }
...
std::vector<unsigned int> MIPS_Simulator::getRegisters() { return registers; }

std::vector<unsigned int> MIPS_Simulator::getMemories() { return memory; }
