...
int main()
{
    ...
    string fileObj;
    string fileAsm;
    return_by_dis disassembleRet; // The disassembleLine function return struct (a bool and string)
...
return_by_dis i_type_decoder(string binaryLine, string opcode, int lineNum)
{
    ...
    // Translates branch_address variable, also changes the address Offset to non-zero if the address must be printed
